...
- 5~10초 사이의 무작위 간격으로 끝까지 진행하는 자동 모드
- Canvas 2D 기반 공 혼합·충돌·배출 연출
...
7. 자동 모드에서는 카운트다운 없이 5~10초 사이에 공이 하나씩 나옵니다.
...
현재 기준으로 7개 테스트 파일의 44개 테스트가 통과합니다. 주요 검증 범위는 다음과 같습니다.
...
- 공은 최대 45개까지 지원합니다.
- Canvas 충돌은 실제 물리 엔진이 아닌 가벼운 시각적 연출입니다.
